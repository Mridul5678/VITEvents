document.addEventListener("DOMContentLoaded", () => {
  ...
  const SHEET_URL = "https://script.google.com/macros/s/AKfycbxsvQBgszIx9MVhF_LdQpC-WyY4mV7XMJFibCpTehVHkfOOQjGG0ixN0VzLXmMK5EJA/exec";
  ...
  const events = [
    {
      id: 1,
      title: "Yantra Central Hack 2026",
      category: "tech",
      date: "2026-02-13",
      time: "09:00",
      ...
      description: "Join us for a 48-hour coding marathon where you can showcase your skills, collaborate with peers, and build innovative solutions to real-world problems.",
      capacity: 200,
      registered: 135,
    },
    {
      ...
      description: "Experience the vibrant cultural diversity of our college through music, dance, art, and food. A celebration of talent and tradition!",
      capacity: 500,
      registered: 370,
    },
    {
      ...
      description: "Compete in various sports including basketball, football, cricket, and athletics. Show your sportsmanship and win exciting prizes!",
      capacity: 200,
      registered: 160,
    },
    {
      ...
      time: "11:00",
      venue: "CS Hall",
      image: "https://images.unsplash.com/photo-1472691681358-fdf00a4bfcfe?q=80&w=2938&auto=format&fit=crop&ixlib=rb-4.0.3",
      description: "Connect with top employers, explore internship and job opportunities, and get insights into various career paths. Bring your resume!",
      capacity: 300,
      registered: 225,
    },
    {
      ...
      description: "Learn about the latest advancements in artificial intelligence and machine learning through hands-on workshops led by industry experts.",
      capacity: 100,
      registered: 40,
    },
    {
      ...
      description: "Celebrate the world of literature with book readings, poetry slams, debates, and interactive sessions with renowned authors.",
      capacity: 150,
      registered: 65,
    },
  ]
  ...
  function closeAllModals() {
    [loginModal, signupModal, createEventModal, registerEventModal].forEach((modal) => {
  ...
  function showToast(message, isSuccess = true) {
    ...
    toastIcon.className = isSuccess
      ...
      : "fas fa-times-circle toast-icon error"
  ...
  if (heroLogin) heroLogin.addEventListener("click", () => openModal(signupModal))
  if (createEventBtn) createEventBtn.addEventListener("click", () => openModal(createEventModal))
  ...
  if (searchEvents) searchEvents.addEventListener("input", filterEvents)
  if (loadMoreBtn) loadMoreBtn.addEventListener("click", () => showToast("No more events to load"))
    ...
    createEventForm.addEventListener("submit", async function (e) {
      ...
      if (validateForm(this)) {
        const proposalData = {
          ...
          posterUrl: document.getElementById("eventImage").value,
          description: document.getElementById("eventDescription").value,
          participants: document.getElementById("eventCapacity").value
        }

        await sendToSheet(proposalData)

        const newEvent = {
          id: events.length + 1,
          title: proposalData.eventName,
          category: proposalData.eventType,
          date: proposalData.eventDate,
          time: proposalData.eventTime,
          venue: proposalData.venue,
          image: proposalData.posterUrl,
          description: proposalData.description,
          capacity: Number.parseInt(proposalData.participants),
          registered: 0,
        }
  ...
  if (registerEventForm) {
    registerEventForm.addEventListener("submit", async function (e) {
      e.preventDefault()
      if (validateForm(this)) {
        ...
        const regData = {
          ...
          mobile: document.getElementById("registerPhone").value,
          regNumber: document.getElementById("registerStudentId").value,
          eventName: document.getElementById("registerEventTitle").textContent || ""
        }

        await sendToSheet(regData)
